<aside class="hidden md:block md:w-56 md:mt-6 md:rounded md:ml-5" style="max-width: 15rem">
    <div class="bg-white p-6 pb-1 pr-6 shadow">
        @yield('sidebar-top')
    ...
    <div class="bg-white p-6 pb-1 pr-5 mt-6 shadow">
        @if (count($trending))
            <div class="widget">
