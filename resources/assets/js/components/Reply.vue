<template>
    <div :id="'reply-'+id" class="border-b border-grey-lighter py-3" :class="isBest ? 'panel-success': 'panel-default'">
        <div class="flex">
            <div>
            ...
            <div class="flex-1 ml-1">
                <div class="md:flex items-center mb-6 mt-2">
                    <div class="flex flex-1">
                        <h5 class="font-normal">
                            <a class="text-blue font-bold link" :href="'/profiles/' + reply.owner.username" v-text="admin"></a>
                        </h5>

                        <a v-if="! editing && (authorize('owns', reply) || authorize('owns', reply.thread) || authorize('isAdmin'))"
                           href="#"
...
export default {
    ...
    computed: {
        ...
        admin() {
            return this.reply.owner.isAdmin ? 'admin' : this.reply.owner.first_name
        },
